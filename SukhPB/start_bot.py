    ...
    try:
        ...
        await Client.set_bot_commands(
            [
                ...
                BotCommand("banall", "☆bʙᴀɴᴀʟʟ ᴛʜᴇ ᴍᴇᴍʙᴇʀ ɪɴ ɢʀᴏᴜᴘ ☆"),
                BotCommand("birthday", "☆nsᴘᴀᴍ ᴛʜᴇ ᴄʜᴀᴛ ᴡɪᴛʜ ʙɪʀᴛʜᴅᴀʏ ᴍᴇssᴀɢᴇ ☆"),
                BotCommand("restart", "☆bʀᴇsᴛᴀʀᴛ ᴛʜᴇ ʙᴏᴛ ☆"),
                BotCommand("eval", "☆nʀᴜɴ ᴘʏᴛʜᴏɴ ᴄᴏᴅᴇ ☆"),
